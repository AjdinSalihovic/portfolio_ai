...
(function () {
  ...
  var BA = {
    ...
    // ---- projects page ----
    "Projects": "Projekti",
    "Things I've<br /><span class=\"title-line\">built & shipped.</span>": "Stvari koje sam<br /><span class=\"title-line\">izgradio i isporučio.</span>",
    "Website development and data engineering projects — from complete builds to data pipelines and visualizations.": "Projekti web razvoja i inženjeringa podataka — od potpune izgradnje do podatkovnih pipeline-a i vizualizacija.",
    "Website Development": "Web razvoj",
    "Complete website builds, redesigns, and e-commerce setups.": "Potpune web izgradnje, redizajni i e-commerce postavke.",
    "Website Redesign": "Redizajn web stranice",
    "Full redesign of an existing shop with improved UX and modern styling.": "Potpun redizajn postojeće trgovine s poboljšanim UX i modernim stilom.",
    "Complete Website Creation": "Potpuna izgradnja web stranice",
    "End-to-end website build — design, development, and deployment from scratch.": "Cjelovita izgradnja web stranice — dizajn, razvoj i implementacija od nule.",
    "WooCommerce Payment Setup": "Postavka WooCommerce plaćanja",
    "Payment integration and WooCommerce configuration for an existing site.": "Integracija plaćanja i konfiguracija WooCommerce za postojeću stranicu.",
    "Live site →": "Živa stranica →",
    "Data Projects": "Data projekti",
    "Data pipelines, visualization, and research projects.": "Data pipeline-i, vizualizacija i istraživački projekti.",
    "Data Pipeline": "Data pipeline",
    "Project for feeding and structuring investor data locally.": "Projekt za hranjenje i strukturiranje investitorskih podataka lokalno.",
    "Visualization": "Vizualizacija",
    "Python-based data visualization projects and analysis notebooks.": "Projekti vizualizacije podataka zasnovani na Pythonu i analitički blokovi.",
    "Research": "Istraživanje",
    "Data research and analysis on Spotify listening patterns and trends.": "Istraživanje i analiza obrazaca slušanja i trendova na Spotify.",
    "GitHub →": "GitHub →",
    "Want to work together?": "Želiš saradnju?",
    "I'm always open to interesting projects — whether it's web development, data engineering, or something in between.": "Uvijek sam otvoren za zanimljive projekte — bilo web razvoj, inženjering podataka, ili nešto između."
  };
  ...
  var DE = {
    ...
    // ---- projects page ----
    "Projects": "Projekte",
    "Things I've<br /><span class=\"title-line\">built & shipped.</span>": "Dinge, die ich<br /><span class=\"title-line\">gebaut und ausgeliefert habe.</span>",
    "Website development and data engineering projects — from complete builds to data pipelines and visualizations.": "Webentwicklungs- und Datenprojekte — von kompletten Builds bis zu Datenpipelines und Visualisierungen.",
    "Website Development": "Webentwicklung",
    "Complete website builds, redesigns, and e-commerce setups.": "Komplette Webseiten-Erstellungen, Redesigns und E-Commerce-Einrichtungen.",
    "Website Redesign": "Webseiten-Redesign",
    "Full redesign of an existing shop with improved UX and modern styling.": "Komplettes Redesign eines bestehenden Shops mit verbessertem UX und modernem Styling.",
    "Complete Website Creation": "Komplette Webseiten-Erstellung",
    "End-to-end website build — design, development, and deployment from scratch.": "End-to-End Webseiten-Erstellung — Design, Entwicklung und Deployment von Grund auf.",
    "WooCommerce Payment Setup": "WooCommerce-Zahlungseinrichtung",
    "Payment integration and WooCommerce configuration for an existing site.": "Zahlungsintegration und WooCommerce-Konfiguration für eine bestehende Seite.",
    "Live site →": "Live-Seite →",
    "Data Projects": "Datenprojekte",
    "Data pipelines, visualization, and research projects.": "Datenpipelines, Visualisierung und Forschungsprojekte.",
    "Data Pipeline": "Datenpipeline",
    "Project for feeding and structuring investor data locally.": "Projekt zum lokalen Speichern und Strukturieren von Investorendaten.",
    "Visualization": "Visualisierung",
    "Python-based data visualization projects and analysis notebooks.": "Python-basierte Datenvisualisierungsprojekte und Analyse-Notebooks.",
    "Research": "Forschung",
    "Data research and analysis on Spotify listening patterns and trends.": "Datenforschung und Analyse von Spotify-Hörgewohnheiten und -Trends.",
    "GitHub →": "GitHub →",
    "Want to work together?": "Zusammenarbeiten?",
    "I'm always open to interesting projects — whether it's web development, data engineering, or something in between.": "Ich bin immer offen für interessante Projekte — ob Webentwicklung, Datenengineering oder etwas dazwischen."
  };
  ...
  var SL = {
    ...
    "ongoing": "poteka",
    "section": "oddelek",
    "Get in touch": "Kontaktiraj me",
    "Full experience →": "Celotne izkušnje →",
    "© 2026 Ajdin Salihović · Tuzla, Bosnia & Herzegovina": "© <span id=\"year\">2026</span> Ajdin Salihović · Tuzla, Bosna in Hercegovina",

    // ---- index: hero ----
    "Unstructured in.Trusted data out.": "Nestrukturirano noter.<br /><span class=\"title-line\">Zanesljivi podatki ven.</span>",
    "Eight years across software, data and AI. I build LLM-powered document processing, production data pipelines, and the validation layers that make both trustworthy — currently engineering the context layer behind AI document extraction at Hypatos.": "Osem let v programiranju, podatkih in umetni inteligenci. Gradim LLM obdelavo dokumentov, produkcijske podatkovne cevi in plasti validacije, ki jih naredijo zanesljive — trenutno razvijam kontekstno plast za AI ekstrakcijo dokumentov pri Hypatos.",
    "Start a project": "Začni projekt",
    "Hi, I'm Ajdin.I think in data.": "Živjo, sem Ajdin.<br /><span class=\"title-line\">Razmišljam v podatkih.</span>",
    "Unstructured in. Trusted data out.": "Nestrukturirano noter. Zanesljivi podatki ven.",
    "How I got here.": "Kako sem prišel sem.",
    "See my work": "Poglej delo",
    "8 yrs": "8 let",
    "4 yrs": "4 leta",
    "software · data · ai": "programiranje · podatki · UI",
    "data platforms in production": "podatkovne platforme v produkciji",
    "msc programs — fin. eng & data science": "magistrski programi — fin. inž. in data science",
    "teaching code, ages 6–18": "učenje programiranja, starost 6–18",

    // ---- index: teasers ----
    "Explore": "Raziskuj",
    "Two ways in.": "Dva načina.",
    "What I build for clients — document automation, data pipelines, scraping & enrichment, dashboards — and the eight-year record behind it.": "Kaj gradim za stranke — avtomatizacija dokumentov, podatkovne cevi, scrapanje in obogatitev, nadzorne plošče — in osemletno izkušnjo za tem.",
    "view services & experience →": "oglej si storitve in izkušnje →",
    "See my experience ↓": "Poglej izkušnje ↓",
    "Three ways in.": "Trije načini.",
    "Work": "Izkušnje",
    "Eight years of roles and systems — from LLM document processing at Hypatos to warehouses on BigQuery, Snowflake and Databricks.": "Osem let vlog in sistemov — od LLM obdelave dokumentov pri Hypatos do skladišč na BigQuery, Snowflake in Databricks.",
    "view experience →": "oglej si izkušnje →",
    "What I build for clients: document automation, data pipelines, scraping & enrichment, dashboards — scoped, shipped, documented.": "Kaj gradim za stranke: avtomatizacija dokumentov, podatkovne cevi, scrapanje in obogatitev, nadzorne plošče — definirano, dostavljeno, dokumentirano.",
    "view services →": "oglej si storitve →",
    "A pipeline to build, documents to structure, or just a question — one message away, answered personally.": "Podatkovna cev za izgradnjo, dokumenti za strukturiranje ali samo vprašanje — eno sporočilo stran, osebno odgovorjeno.",
    "say hello →": "reci živjo →",
    "@dataminerinsights — 60K investors circling. Buy them or subscribe for the Friday drop.": "<b>@dataminerinsights</b> — 60K vlagateljev v obtoku. Kupite jih ali se naročite na petkov padec.",
    "read on substack →": "beri na substacku →",
    "About me": "O meni",

    // ---- index: current focus ----
    "Right now": "Trenutno",
    "Current focus.": "Trenutni fokus.",
    "Engineering the context layer behind LLM-based document processing — extraction schemas, prompts and ground-truth datasets.": "Razvijam kontekstno plast za LLM obdelavo dokumentov — sheme ekstrakcije, pozive in nabor podatkov ground-truth.",
    "Building evaluation sets and error taxonomies that feed back into engineering and raise extraction accuracy.": "Gradim evalvacijske nabora in taksonomije napak, ki se vračajo v inženiring in dvigujejo natančnost ekstrakcije.",

    // ---- index: about ----
    "Hi, I'm Ajdin. I think in data.": "Živjo, sem Ajdin. Razmišljam v podatkih.",
    "I've spent eight years moving across the stack — web development, then QA, then data engineering, and now AI. That path wasn't an accident: each stop taught me a habit the next one needed. QA made me distrust every record until it's validated. Warehousing taught me that pipelines fail at 3 a.m., so they'd better log well. LLM work taught me that the model is only as good as the context you engineer around it.": "Osem let sem se premikal po celem skladu — spletni razvoj, potem QA, potem inženiring podatkov, zdaj AI. Ta pot ni bila naključna: vsaka postaja me je naučila navade, ki jo je naslednja potrebovala. QA me je naučil, da ne zaupam nobenemu zapisu, dokler ni validiran. Skladiščenje me je naučilo, da cevi odpovedujejo ob 3 zjutraj, zato morajo dobro beležiti. Delo z LLM me je naučilo, da je model tako dober, kot je dober kontekst, ki ga zgradiš okoli njega.",
    "Today I work on LLM-powered document processing — the unglamorous, high-value problem of turning contracts, invoices and scanned forms into data a business can actually trust. On the side, I take freelance projects and study financial engineering, because markets are just another messy data source waiting for structure.": "Danes delam na LLM obdelavi dokumentov — neglamurozna, a dragocena naloga pretvarjanja pogodb, faktur in skeniranih obrazcev v podatke, katerim podjetje resnično lahko zaupa. Ob strani sprejemam freelance projekte in študiram finančni inženiring, ker so tržišča samo še en neurejen vir podatkov, ki čaka na strukturo.",
    "Since 2022 I've also taught programming to kids aged 6 to 18. Four years of explaining recursion to ten-year-olds is the best communication training an engineer can get — if you can't make it clear to them, you don't understand it well enough yourself.": "Od 2022 učim programiranje otroke od 6 do 18 let. Štiri leta razlage rekurzije desetletnikom je najboljši komunikacijski trening, ki ga inženjer lahko dobi — če jim tega ne znaš pojasniti, tega sam ne dovolj dobro razumeš.",
    "Off the clock I post about data and AI as @ajdin_thinks_data — the handle is honest, it's how my brain works. I speak Bosnian and English fluently, get by in Slovene, and I'm slowly convincing German to cooperate.": "Prost delovni čas objavljam o podatkih in UI kot <a href=\"https://www.instagram.com/ajdin_thinks_data/\" target=\"_blank\" rel=\"noopener\">@ajdin_thinks_data</a> — vzdevek iskren, tako mi deluje možgane. Tekoče govorim bosansko in angleško, se znajdem v slovenščini, nemščino pa počasi prepričujem k sodelovanju.",
    "education": "izobrazba",
    "WorldQuant University · Apr 2025 – Sep 2027 (in progress, remote)": "WorldQuant University · apr 2025 – sep 2027 (v teku, na daljavo)",
    "certifications": "certifikati",
    "languages": "jeziki",
    "bosnian": "bosanščina",
    "english": "angleščina",
    ...
    "german": "nemščina",
    "Native": "maternji",
    "C2 — full professional fluency": "C2 — polna profesionalna tekočnost",
    "A1 — and climbing": "A1 — in narašča",

    // ---- record meta ----
    "period Jul 2026 – present": "<span class=\"field\">obdobje</span> jul 2026 – danes",
    "location Germany (remote)": "<span class=\"field\">lokacija</span> Nemčija (na daljavo)",
    "period Apr 2026 – Jul 2026": "<span class=\"field\">obdobje</span> apr 2026 – jul 2026",
    "location remote": "<span class=\"field\">lokacija</span> na daljavo",
    "period Feb 2025 – Apr 2026": "<span class=\"field\">obdobje</span> feb 2025 – apr 2026",
    "location Tuzla, BiH": "<span class=\"field\">lokacija</span> Tuzla, BiH",
    "period Oct 2024 – Feb 2025": "<span class=\"field\">obdobje</span> okt 2024 – feb 2025",
    "period Aug 2024 – Dec 2024": "<span class=\"field\">obdobje</span> avg 2024 – dec 2024",
    "period Oct 2022 – Jul 2023": "<span class=\"field\">obdobje</span> okt 2022 – jul 2023",
    "location Sarajevo, BiH": "<span class=\"field\">lokacija</span> Sarajevo, BiH",
    "period Oct 2020 – Sep 2022": "<span class=\"field\">obdobje</span> okt 2020 – sep 2022",
    "period Feb 2018 – Oct 2019": "<span class=\"field\">obdobje</span> feb 2018 – okt 2019",
    "location BiH": "<span class=\"field\">lokacija</span> BiH",
    "period Feb 2022 – present": "<span class=\"field\">obdobje</span> feb 2022 – danes",

    // ---- work page ----
    "The record,role by role.": "Zapis,<br /><span class=\"title-line\">vloga za vlogo.</span>",
    "Every role below shaped how I build today: QA taught me to distrust data until it's validated, warehousing taught me scale, and LLM work taught me that context is the product.": "Vsaka vloga spodaj je oblikovala način, kako danes gradim: QA me je naučil, da ne zaupam podatkom, dokler niso validirani, skladiščenje me je naučilo merila, delo z LLM pa me je naučilo, da je kontekst izdelek.",
    "Experience.": "Izkušnje.",
    "Engineer the context layer behind LLM-based document processing — extraction schemas, prompts and ground-truth datasets that drive automated capture of structured data from unstructured business documents.": "Razvijam kontekstno plast za LLM obdelavo dokumentov — sheme ekstrakcije, pozive in nabor podatkov ground-truth, ki poganjajo samodejno zajemanje strukturiranih podatkov iz nestrukturiranih poslovnih dokumentov.",
    "Build evaluation sets and error taxonomies from model output, feeding structured findings back to engineering to raise extraction accuracy and reduce manual review.": "Gradim evalvacijske nabora in taksonomije napak iz izhoda modela, strukturirane ugotovitve vračam v inženiring za dvig natančnosti ekstrakcije in zmanjšanje ročnega pregleda.",
    "Automate data preparation, validation and reporting across large document corpora with Python and SQL.": "Avtomatiziram pripravo, validacijo in poročanje podatkov nad velikimi korpusi dokumentov s Pythonom in SQL.",
    "Built automated acquisition and enrichment pipelines combining third-party APIs (Apollo, Airtable, Google Workspace) with LLM agents to research, structure and validate investor data at scale.": "Zgradil avtomatizirane cevi za pridobivanje in obogatitev, ki kombinirajo API-je tretjih strani (Apollo, Airtable, Google Workspace) z LLM agenti za raziskovanje, strukturiranje in validacijo podatkov vlagateljev v merilu.",
    "Designed reusable Python automation and multi-stage QA workflows that replaced manual research steps and enforced validation rules on every record.": "Oblikoval ponovno uporabno Python avtomatizacijo in večstopenjske QA poteka, ki so zamenjali ročne korake raziskovanja in uveljavili validacijska pravila na vsakem zapisu.",
    "Integrated LLM tooling into internal processes and documented repeatable workflows adopted by the wider team.": "Integriral LLM orodja v interne procese in dokumentiral ponovljive poteka dela, ki jih je sprejel širši tim.",
    "Owned quality for a multi-platform banking product across web, iOS and Android — test design, regression, functional, UI and exploratory testing managed in TestRail.": "Odgovoren za kakovost večplatformskega bančnega izdelka na spletu, iOS in Androidu — oblikovanje testov, regresijsko, funkcionalno, UI in raziskovalno testiranje voden v TestRail.",
    "Debugged issues across the stack using logs, API responses and multiple environments, working directly with developers and product.": "Odpravljal težave po celem skladu z uporabo dnevnikov, API odzivov in več okolij, delal neposredno z razvijalci in produktom.",
    "Improved release confidence through systematic edge-case coverage and maintained test documentation.": "Izboljšal zaupanje v izdaje s sistematičnim pokrivanjem robnih primerov in vzdrževano testno dokumentacijo.",
    "Designed and maintained BigQuery data warehouses and ETL/ELT pipelines on GCP supporting analytics and reporting for product and marketing teams.": "Oblikoval in vzdrževal BigQuery skladišča podatkov in ETL/ELT cevi na GCP za analitiko in poročanje produktov in marketinških timov.",
    "Developed modular Python services for recurring ingestion, cleaning and transformation.": "Razvil modularne Python servise za ponavljajoče se vnose, čiščenje in transformacijo.",
    "Integrated third-party APIs (Google Analytics, Hyros) for attribution data and delivered Looker Studio dashboards used across the organisation.": "Integriral API-je tretjih strani (Google Analytics, Hyros) za atribucijske podatke in dostavil Looker Studio nadzorne plošče, ki se uporabljajo po vsej organizaciji.",
    "Spearheaded a custom data platform on PySpark and Databricks, transforming raw streaming data into gold-layer analytics datasets.": "Vodil izgradnjo merjene podatkovne platforme na PySpark in Databricks, pretvarjanje surovih pretakajočih se podatkov v gold-layer analitične nabora.",
    "Wrote scalable, testable Python modules for validation, transformation and enrichment.": "Pisal skalabilne, testljive Python module za validacijo, transformacijo in obogatitev.",
    "Developed and maintained Python Airflow DAGs automating ETL processes, with advanced error-handling and logging.": "Razvil in vzdrževal Python Airflow DAG-ove za avtomatizacijo ETL procesov z naprednim ravnanjem z napakami in beleženjem.",
    "Designed performant SQL queries and data models on Snowflake and Oracle for near real-time analytics use cases.": "Oblikoval zmogljive SQL poizvedbe in modele podatkov na Snowflake in Oracle za skoraj realnočasovno analitiko.",
    "Built and monitored production pipelines on Redshift and Snowflake using Python, Airflow and shell scripting.": "Gradil in nadzoroval produkcijske cevi na Redshift in Snowflake z uporabo Python, Airflow in shell skript.",
    "Drove data quality and reliability improvements through validation checks, refactoring and clearer logging.": "Poganjal izboljšave kakovosti in zanesljivosti podatkov prek validacijskih preverjanj, preoblikovanja in jasnejšega beleženja.",
    "Built and shipped web applications with Angular, Drupal, JavaScript, jQuery and HTML/CSS, with automated UI testing in Selenium.": "Gradil in dostavljal spletne aplikacije z Angular, Drupal, JavaScript, jQuery in HTML/CSS z avtomatiziranim UI testiranjem v Selenium.",
    "Produced mockups and drafts for client sites and documented implementation step by step.": "Izdelal makete in osnutke za strankine strani in dokumentiral izvedbo korak za korakom.",
    "Programming Instructor": "Inštruktor programiranja",
    "Teach Python, C# and web fundamentals to students aged 6–18 — four years of practice turning complex technical ideas into clear, accessible explanations.": "Učim Python, C# in spletne osnove učence od 6 do 18 let — štiri leta prakse pretvarjanja zapletenih tehničnih idej v jasna, dostopna pojasnila.",
    "Earlier roles": "Prejšnje vloge",
    "Technical Support Analyst — Marvelsoft: log analysis, Sphinx documentation, GitLab.": "<b>Technical Support Analyst — Marvelsoft</b>: analiza dnevnikov, Sphinx dokumentacija, GitLab.",
    "Software Engineer — Alfa24: Vue.js, PostgreSQL.": "<b>Software Engineer — Alfa24</b>: Vue.js, PostgreSQL.",
    "Web Developer — Leftor d.o.o.: PHP, Yii, HTML5/CSS3.": "<b>Web Developer — Leftor d.o.o.</b>: PHP, Yii, HTML5/CSS3.",
    "Toolbox": "Orodjarna",
    "Skills, grouped.": "Spretnosti, razvrščene.",
    "LLM-based document processing & data extraction, prompt and context engineering, RAG, embeddings & vector search, evaluation sets and error analysis, LLM/agent APIs, MCP tooling": "LLM obdelava dokumentov in ekstrakcija podatkov, inženiring pozivov in konteksta, RAG, vstavki in vektorsko iskanje, evalvacijski nabora in analiza napak, LLM/agent API-ji, MCP orodja",
    "Python (FastAPI, Flask), REST API design & integration, background jobs and scheduling, asynchronous / event-driven processing, C#": "Python (FastAPI, Flask), oblikovanje in integracija REST API-jev, ozadjska dela in razporejanje, asinhrone / dogodkovno vodene obdelave, C#",
    "JavaScript, Angular, Vue.js, HTML5, CSS3, responsive UI work — TypeScript / React actively learning": "JavaScript, Angular, Vue.js, HTML5, CSS3, odzivno UI delo — TypeScript / React aktivno učim",
    "data & databases": "podatki in baze podatkov",
    "Advanced SQL, PostgreSQL, Oracle, Snowflake, BigQuery, Redshift, MongoDB, Cassandra; DBT, Airflow, Fivetran, PySpark, Databricks; ETL/ELT, warehouse & lakehouse design": "Napredni SQL, PostgreSQL, Oracle, Snowflake, BigQuery, Redshift, MongoDB, Cassandra; DBT, Airflow, Fivetran, PySpark, Databricks; ETL/ELT, oblikovanje skladišč in jezer",
    "Google Cloud Platform, AWS (S3, Athena), Azure, Docker, Kubernetes, Git/GitLab, Linux, logging & monitoring": "Google Cloud Platform, AWS (S3, Athena), Azure, Docker, Kubernetes, Git/GitLab, Linux, beleženje in nadzor",
    "quality": "kakovost",
    "Test design & automation (Selenium, TestRail), data validation, debugging & performance analysis, technical documentation (Sphinx), Agile/Scrum, Jira": "Oblikovanje in avtomatizacija testov (Selenium, TestRail), validacija podatkov, odpravljanje napak in analiza zmogljivosti, tehnična dokumentacija (Sphinx), Agile/Scrum, Jira",

    // ---- freelance page ----
    "Have a data problem?I build the fix.": "Imate problem s podatki?<br /><span class=\"title-line\">Jaz zgradim rešitev.</span>",
    "I take projects end to end — scoping, backend and API development, containerised cloud deployment, and handover documentation your team can actually maintain. If it involves messy data, repetitive work, or documents nobody wants to read, it's probably my kind of project.": "Prevzam projekte od začetka do konca — določitev obsega, backend in API razvoj, kontejneriziran cloud deployment in predajo dokumentacije, ki jo vaš tim resnično lahko vzdržuje. Če vključuje neurejene podatke, ponavljajoče se delo ali dokumente, ki jih nihče ne želi brati, je verjetno moj tip projekta.",
    "Tell me what you're building": "Povej mi, kaj gradiš",
    "Services": "Storitve",
    "What I build for clients.": "Kaj gradim za stranke.",
    "service": "storitev",
    "LLM document automation": "LLM avtomatizacija dokumentov",
    "Invoices, contracts, forms, reports — extracted into structured, validated data with LLM pipelines, evaluation sets and human-auditable review workflows. The same discipline I apply at Hypatos, scaled to your documents.": "Fakture, pogodbe, obrazci, poročila — ekstrahirani v strukturirane, validirane podatke z LLM cevmi, evalvacijskimi nabori in preglednimi poteki dela. Ista disciplina, ki jo uporabljam pri Hypatos, prilagojena vašim dokumentom.",
    "Data pipelines & warehousing": "Podatkovne cevi in skladiščenje",
    "Ingestion, ETL/ELT, modelling and orchestration on BigQuery, Snowflake, Redshift or Databricks — with the error handling, logging and validation that keep pipelines boring in the best way.": "Vnos, ETL/ELT, modeliranje in orkestracija na BigQuery, Snowflake, Redshift ali Databricks — z ravnanjem z napakami, beleženjem in validacijo, ki cevi ohranjajo dolgočasne na najboljši način.",
    "Web data acquisition & enrichment": "Pridobivanje in obogatitev spletnih podatkov",
    "Scraping, API integration, deduplication, enrichment and QA rules that turn the open web into structured records delivered to the tools your team already uses — Airtable, Notion, sheets, or a custom app.": "Scrapanje, integracija API-jev, deduplikacija, obogatitev in QA pravila, ki odprti splet pretvarjajo v strukturirane zapise, dostavljene v orodja, ki jih vaš tim že uporablja — Airtable, Notion, preglednice ali merjena aplikacija.",
    "Dashboards & automated reporting": "Nadzorne plošče in avtomatizirano poročanje",
    "Looker Studio dashboards and scheduled reporting built on clean, validated data — plus the automations that save your team a week every month.": "Looker Studio nadzorne plošče in načrtovano poročanje zgrajeno na čistih, validiranih podatkih — plus avtomatizacije, ki vašemu timu prihranijo teden vsak mesec.",
    "everything else": "vse ostalo",
    "Not on the list? Ask anyway.": "Ni na seznamu? Vseeno vprašaj.",
    "If it's technical, I can build it or write it — scripts, integrations, internal tools, technical documentation, data cleanups, one-off automations, or the weird project that doesn't fit a category. Describe the problem; I'll tell you honestly whether I'm the right person for it, and what it would take.": "Če je tehnično, to lahko zgradim ali napišem — skripte, integracije, interna orodja, tehnična dokumentacija, čiščenje podatkov, enkratne avtomatizacije ali nenavaden projekt, ki ne ustreza nobeni kategoriji. Opišite problem; iskreno vam bom povedal, ali sem prava oseba za to in kaj bi bilo potrebno.",
    "Describe your problem →": "Opišite svoj problem →",
    "Process": "Proces",
    "How working together goes.": "Kako poteka sodelovanje.",
    "ScopeA short call or email thread to understand the problem, the data, and what \"done\" looks like. Free, no commitment.": "<div><b>Obseg</b><p>Kratek klic ali e-poštna nit za razumevanje problema, podatkov in tega, kako izgleda \"končano\". Brezplačno, brez obveznosti.</p></div>",
    "ProposalA written plan: deliverables, timeline, and a fixed or milestone-based price. No surprises later.": "<div><b>Ponudba</b><p>Pisni plan: dostave, časovnica in fiksna cena ali cena po mejnikih. Brez presenečenj kasneje.</p></div>",
    "BuildIterative development with regular demos, so you see progress on real data — not just status updates.": "<div><b>Izgradnja</b><p>Iterativni razvoj z rednimi demonstracijami, da napredek vidite na pravih podatkih — ne samo posodobitvah stanja.</p></div>",
    "HandoverDeployed, documented, and explained. You own the code, and your team knows how to run it.": "<div><b>Predaja</b><p>Objavljeno, dokumentirano in pojasnjeno. Kodo posedujete, vaš tim pa ve, kako jo zagnati.</p></div>",
    "Send an inquiry": "Pošlji povpraševanje",
    "Email me directly": "Pišite mi neposredno",

    // ---- contact page ----
    "Contact": "Kontakt",
    "Questions, ideas,or a project brief?": "Vprašanja, ideje<br /><span class=\"title-line\">ali projektna naloga?</span>",
    "Whether it's a pipeline that needs building, documents that need structure, or an automation that would save your team a week every month — send a message and I'll reply personally.": "Ne glede na to, ali gre za cev, ki jo je treba zgraditi, dokumente, ki potrebujejo strukturo, ali avtomatizacijo, ki bi vašemu timu prihranila teden vsak mesec — pošljite sporočilo in odgovoril bom osebno.",
    "name": "ime",
    "email": "e-pošta",
    "message": "sporočilo",
    "Send message": "Pošlji sporočilo",
    "Open in your email app": "Odpri v e-poštni aplikaciji",
    "Goes straight to my inbox — I reply personally, usually within a day.": "Gre naravnost v moj nabiralnik — odgovarjam osebno, običajno v enem dnevu.",
    "Prefer email directly? This works too.": "Raje neposredno po e-pošti? Tudi to dela.",
    "professional": "poklicno",
    "social": "družbena omrežja",
    "@ajdin_thinks_data — thoughts on data and AI, in between the pipelines.": "<a href=\"https://www.instagram.com/ajdin_thinks_data/\" target=\"_blank\" rel=\"noopener\">@ajdin_thinks_data</a> — misli o podatkih in UI, med cevmi.",

    // ---- projects page ----
    "Projects": "Projekti",
    "Things I've<br /><span class=\"title-line\">built & shipped.</span>": "Stvari, ki sem jih<br /><span class=\"title-line\">zgradil in dostavil.</span>",
    "Website development and data engineering projects — from complete builds to data pipelines and visualizations.": "Projekti spletnega razvoja in inženiringa podatkov — od popolnih izgradenj do podatkovnih cevi in vizualizacij.",
    "Website Development": "Spletni razvoj",
    "Complete website builds, redesigns, and e-commerce setups.": "Popolne spletne izgradnje, preoblikovanja in e-commerce nastavitve.",
    "Website Redesign": "Preoblikovanje spletne strani",
    "Full redesign of an existing shop with improved UX and modern styling.": "Popolno preoblikovanje obstoječe trgovine z izboljšanim UX in modernim slogom.",
    "Complete Website Creation": "Popolna izgradnja spletne strani",
    "End-to-end website build — design, development, and deployment from scratch.": "Celovita izgradnja spletne strani — oblikovanje, razvoj in objava od začetka.",
    "WooCommerce Payment Setup": "Nastavitev WooCommerce plačil",
    "Payment integration and WooCommerce configuration for an existing site.": "Integracija plačil in konfiguracija WooCommerce za obstoječe mesto.",
    "Live site →": "Živo mesto →",
    "Data Projects": "Podatkovni projekti",
    "Data pipelines, visualization, and research projects.": "Podatkovne cevi, vizualizacija in raziskovalni projekti.",
    "Data Pipeline": "Podatkovna cev",
    "Project for feeding and structuring investor data locally.": "Projekt za hranjenje in strukturiranje podatkov vlagateljev lokalno.",
    "Visualization": "Vizualizacija",
    "Python-based data visualization projects and analysis notebooks.": "Projekti vizualizacije podatkov na osnovi Pythona in analizni zvezki.",
    "Research": "Raziskava",
    "Data research and analysis on Spotify listening patterns and trends.": "Raziskava in analiza poslušalnih vzorcev in trendov na Spotify.",
    "GitHub →": "GitHub →",
    "Want to work together?": "Želiš sodelovati?",
    "I'm always open to interesting projects — whether it's web development, data engineering, or something in between.": "Vedno sem odprt za zanimive projekte — naj bo spletni razvoj, inženiring podatkov ali nekaj vmes.",

    // ---- thanks page ----
    "status: delivered": "status: dostavljeno",
    "Message sent.Talk soon.": "Sporočilo poslano.<br /><span class=\"title-line\">Kmalu se slišimo.</span>",
    "Your message is in my inbox — I reply personally, usually within a day. In the meantime, feel free to look around.": "Vaše sporočilo je v mojem nabiralniku — odgovarjam osebno, običajno v enem dnevu. Medtem si lahko ogledate stran.",
  ...
  var PLACEHOLDERS = {
    ...
    sl: { name: "Vaše ime", email: "vi@podjetje.si", message: "Kaj gradite? Kateri podatki so vključeni in kako naj bi izgledal rezultat?" }
  };

  var DICTS = { ba: BA, de: DE, sl: SL };
  var LANG_CODES = { en: "en", ba: "bs", de: "de", sl: "sl" };
